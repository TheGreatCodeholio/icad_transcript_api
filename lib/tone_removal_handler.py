...
def apply_agc_with_silence_detection(audio_segment, target_peak=-2.0, silence_threshold=-40.0, clipping_threshold=-2.0):
    """
    ...
    """
    segments = split_audio(audio_segment, chunk_length=500)  # Split into chunks, e.g., every 1000ms.
    processed_segments = []
